      ...
      {isOpenEditModal &&
        <div className="fixed z-10 top-0 left-0 w-full h-full bg-black/80">
          ...
          <form action={formAction}>
            ...
            {isPending && <p className="text-2xl font-bold text-green-500 mb-2">現場情報を更新しています</p>}
            <div className="flex gap-8">
              ...
              <button onClick={() => setIsOpenEditModal(false)} className="basis-1/2 block text-white text-2xl font-bold h-14 rounded-md bg-gray-500 hover:bg-gray-600 cursor-pointer disabled:bg-gray-600" disabled={isPending}>キャンセル</button>
            </div>
          </form>
